...
void COOLWSD::defineOptions(Poco::Util::OptionSet& optionSet)
{
    ...
    optionSet.addOption(Option("use-env-vars", "",
                               ...
                               "the documented Online Office container environment variables to set options. "
    ...
    if constexpr (Util::isDebugEnabled())
    {
        ...
        optionSet.addOption(Option("singlekit", "", "Spawn one Online Office kit.")
                                .required(false)
                                .repeatable(false));
...
void COOLWSD::displayHelp()
{
    ...
    helpFormatter.setHeader("Online Office WebSocket server.");
