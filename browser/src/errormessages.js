...
errorMessages.websocketproxyfailure = _('Failed to establish the socket connection, or the connection closed unexpectedly. The reverse proxy might be misconfigured; contact the administrator and check the Online Office deployment documentation.');
